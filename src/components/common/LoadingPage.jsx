  ...
  <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center">
    ...
    <div className="relative w-40 h-40 flex items-center justify-center mb-4">
      <svg className="absolute inset-0 w-full h-full opacity-20" viewBox="0 0 160 160">
        <ellipse cx="80" cy="80" rx="60" ry="40" fill="none" stroke="#6366f1" strokeWidth="1.5" strokeDasharray="6 4" />
      </svg>
      <div className="plane-anim">
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
          <path d="M6 24L24 8L42 24L34 26L30 40L24 34L18 40L14 26Z" fill="#6366f1" />
          <path d="M24 34L22 42L24 40L26 42Z" fill="#4f46e5" />
        </svg>
      </div>
    </div>

    <p className="text-anim text-2xl font-bold text-white tracking-tight">
      FlightBook Admin
    </p>
    <p className="text-sm text-slate-400 mt-1">Loading dashboard…</p>
  </div>
);
